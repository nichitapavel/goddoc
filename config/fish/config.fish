...
if status is-interactive
  ...
  abbr --add update-dist "sudo apt update && sudo apt upgrade -y && sudo apt full-upgrade -y && sudo apt-get autoremove -y && sudo apt-get autoclean && tldr --update && pyenv update"
end
